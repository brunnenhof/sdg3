...
sign_up = [
  "Thanks for taking the time to explore the connections between poverty, inequality, empowerment, food and agriculture, and energy. The game is complicated, the future uncertain, but have no fear! We will guide you every step of the way, and you can intervene three times in the course of events to tweak the future for a better outcome: When you take decisions for your own future, then for the future of your children and lastly, for the future of your grandchildren.",
  "Vielen Dank, dass Sie sich die Zeit genommen haben, die Zusammenhänge zwischen Armut, Ungleichheit, Empowerment, Ernährung und Landwirtschaft sowie Energie zu erkunden. Das Spiel ist kompliziert, die Zukunft ungewiss, aber keine Angst! Wir begleiten Sie bei jedem Schritt, und Sie können dreimal in den Verlauf der Zukunft eingreifen um sie zum Guten zu wenden: Wenn Sie Entscheidungen für Ihre eigene Zukunft treffen, dann für die Zukunft Ihrer Kinder und schließlich für die Zukunft Ihrer Enkelkinder.",
  "Vielen Dank, dass Sie sich die Zeit genommen haben, die Zusammenhänge zwischen Armut, Ungleichheit, Empowerment, Ernährung und Landwirtschaft sowie Energie zu erkunden. Das Spiel ist kompliziert, die Zukunft ungewiss, aber keine Angst! Wir begleiten Sie bei jedem Schritt, und Sie können dreimal in den Verlauf der Zukunft eingreifen um sie zum Guten zu wenden: Wenn Sie Entscheidungen für Ihre eigene Zukunft treffen, dann für die Zukunft Ihrer Kinder und schließlich für die Zukunft Ihrer Enkelkinder.",
  "Merci d'avoir pris le temps d'explorer les liens entre pauvreté, inégalités, autonomisation, alimentation et agriculture, et énergie. Le jeu est compliqué, l'avenir incertain, mais n'ayez crainte ! Nous vous accompagnons à chaque étape et vous pouvez intervenir trois fois dans le cours des événements pour les faire évoluer dans le bon sens : lorsque vous prenez des décisions pour votre propre avenir, puis pour celui de vos enfants et enfin pour celui de vos petits-enfants.",
  "Takk for at du tar deg tid til å utforske sammenhengen mellom fattigdom, ulikhet, myndiggjøring, mat og landbruk og energi. Spillet er komplisert, fremtiden er usikker, men ikke vær redd! Vi følger deg hvert steg på veien, og du kan gripe inn tre ganger i løpet av hendelsene for å justere fremtiden for et bedre resultat: Når du tar beslutninger for din egen fremtid, deretter for dine barns fremtid og til slutt for dine barnebarns fremtid.",
  "_last_"  
]
sign_up_title = [
  "New registration",
