...
gm_checkbox_open_tx = [
    ...
    "Be spillerne se på tilstanden i regionen deres de siste 35 årene og diskutere i teamet sitt og på tvers av teamene hvilke beslutninger de vil ta for å forbedre livene til innbyggerne. \n\nNedenfor er det en avkrysningsboks for å godta spillernes beslutninger for neste runde. Men før du krysser av i boksen med en gang, bør du vurdere om du først vil ha en debriefing/diskusjon, eller om du vil fortsette spillet senere, for eksempel etter lunsj, neste uke, i neste undervisningstime osv.",
    "_last_"
]
