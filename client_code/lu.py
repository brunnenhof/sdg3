...
login_str_gm = [
  "In order to continue playing the game after a game has been interrupted, by accident or on purpose, you must log in so that we can show you the correct page in the game after an interruption.\n\nYour login e-mail does not have to be your real one. It can be a fantasy address like abc@def.ghi - but the @ sign and the dot must be included. \n\nPlease note: if you do enter a fantasy address, you cannot recover a forgotten password! You can choose whatever password you want, even nothing at all! But remember what you enter well - after an interruption you have to enter both exactly the same again.",
  "Um bei Spiel-unterbrechungen, gewollt oder ungewollt, das Spiel trotzdem weiter spielen zu können, müssen Sie sich einloggen, damit wir Ihnen nach einer Unterbrechung zielgenau die richtige Seite im Spiel anzeigen können.\n\nIhre Anmelde-e-mail muss nicht Ihre richtige sein. Es kann auch eine Phantasieadresse sein wie abc@def.ghi - aber das @ Zeichen und der Punkt müssen beide enthalten sein. \n\nBitte beachten Sie: Wenn Sie eine Fantasieadresse eingeben, können Sie ein vergessenes Passwort nicht wiederherstellen! Als Password können Sie wählen was Sie wollen, auch gar nichts! Aber, merken Sie sich was immer Sie eingegeben haben sehr gut - nach einer Unterbrechung müssen Sie beides wieder genauso eingeben.\n\nWir nutzen das eingebaute Login-System von anvil.works das nur in English existiert, leider haben wir noch nicht raus gefunden wie man die Prompts übersezt.",
  "Um bei Spiel-unterbrechungen, gewollt oder ungewollt, das Spiel trotzdem weiter spielen zu können, musst Du dich einloggen, damit wir Dir nach einer Unterbrechung zielgenau die richtige Seite im Spiel anzeigen können.\n\nDeine Anmelde-e-mail muss nicht Deine richtige sein. Es kann auch eine Phantasieadresse sein wie abc@def.ghi - aber das @ Zeichen und der Punkt müssen beide enthalten sein. \n\nBitte beachte: Wenn Du eine Fantasieadresse eingibst, kannst Du ein vergessenes Passwort nicht wiederherstellen! Als Password kannst Du wählen was Du willst, auch gar nichts! Aber, merke Dir was immer Du eingegeben hast sehr gut - nach einer Unterbrechung musst Du beides wieder genauso eingeben.\n\nWir nutzen das eingebaute Login-System von anvil.works das nur in English existiert, leider haben wir noch nicht raus gefunden wie man die Prompts übersezt.",
  "Pour pouvoir continuer à jouer après une interruption du jeu, qu'elles soient intentionnelles ou non, vous devez vous connecter afin que nous puissions vous montrer la bonne page du jeu après une interruption.\n\nVotre adresse électronique de connexion ne doit pas nécessairement être votre véritable adresse. Il peut s'agir d'une adresse fantaisiste comme abc@def.ghi - mais le signe @ et le point doivent être inclus. \n\nAttention : si vous entrez une adresse fantaisiste, vous ne pouvez pas récupérer un mot de passe oublié ! Vous pouvez choisir n'importe quel mot de passe, même rien du tout ! Mais souvenez-vous bien de ce que vous entrez - après une interruption, vous devez entrer à nouveau les deux exactement de la même manière.\n\nNous utilisons le système de connexion intégré d'anvil.works qui n'existe qu'en anglais, malheureusement nous n'avons pas encore trouvé comment traduire les messages-guides.",
  "For å kunne fortsette å spille spillet etter at et spill er blitt avbrutt, enten de er tilsiktede eller utilsiktede, må du logge inn slik at vi kan vise deg riktig side i spillet etter et avbrudd.\n\nDin innloggings-e-post trenger ikke å være din virkelige. Det kan være en fantasiadresse som abc@def.ghi - men @-tegnet og punktummet må være med. \n\nMerk: Hvis du oppgir en fantasiadresse, kan du ikke gjenopprette et glemt passord! Du kan velge hvilket passord du vil, til og med ikke noe i det hele tatt! Men husk godt hva du skriver inn - etter et avbrudd må du skrive inn begge nøyaktig det samme igjen.\n\nVi bruker det innebygde innloggingssystemet til anvil.works som bare finnes på engelsk, dessverre har vi ennå ikke funnet ut hvordan vi skal oversette instruksjonene.",
  "_last_"
]
login_str_p = [
  "",
