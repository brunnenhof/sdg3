...
gm_card_wait_1_info_tx_str = [
  "All roles have been set up now. \nTell your players to log in, to look at the state of their region for last 45 years and discuss their decisions to improve the lives of their people. Check repeatedly if all your players have logged in by clicking the **Check LogIn** button. Once they are ready to proceed to the next round **---** *this will take some time!* **---** click on the **Advance the model for the next round** button. If the *advance* button does not show, your players are not ready yet. ",
  "Alle Rollen wurden nun eingerichtet. \nBitten Sie Ihre Spieler, sich einzuloggen, den Zustand ihrer Region in den letzten 45 Jahren zu betrachten und ihre Entscheidungen zur Verbesserung des Lebens ihrer Bevölkerung zu diskutieren. Überprüfen Sie wiederholt, ob sich alle Ihre Spieler angemeldet haben, indem Sie auf die Schaltfläche **Anmeldungen prüfen** klicken. Sobald sie bereit sind, mit der nächsten Runde fortzufahren, **---** *das kann dauern!* **---** klicken Sie auf die Schaltfläche **Modell für die nächste Runde laufen lassen**. Wenn die Schaltfläche * Modell für die nächste Runde laufen lassen* nicht angezeigt wird, sind Ihre Spieler noch nicht soweit. ",
  "Alle Rollen wurden nun eingerichtet. \nBitten Sie Ihre Spieler, sich einzuloggen, den Zustand ihrer Region in den letzten 45 Jahren zu betrachten und ihre Entscheidungen zur Verbesserung des Lebens ihrer Bevölkerung zu diskutieren. Überprüfen Sie wiederholt, ob sich alle Ihre Spieler angemeldet haben, indem Sie auf die Schaltfläche **Anmeldungen prüfen** klicken. Sobald sie bereit sind, mit der nächsten Runde fortzufahren, **---** *das kann dauern!* **---** klicken Sie auf die Schaltfläche **Modell für die nächste Runde laufen lassen**. Wenn die Schaltfläche * Modell für die nächste Runde laufen lassen* nicht angezeigt wird, sind Ihre Spieler noch nicht soweit. ",
  "Tous les rôles ont maintenant été mis en place. \nDemandez à vos joueurs de se connecter, d'examiner l'état de leur région au cours des 45 dernières années et de discuter de leurs décisions pour améliorer la vie de leur population. Vérifiez à plusieurs reprises que tous vos joueurs se sont connectés en cliquant sur le bouton **Vérifier les connexions**. Dès qu'ils sont prêts à passer au tour suivant, **---** *cela peut prendre du temps!* **---** cliquez sur le bouton **Lancer le modèle pour le tour suivant**. Si le bouton * Lancer le modèle pour le prochain tour* n'apparaît pas, cela signifie que vos joueurs ne sont pas encore prêts. " 
  "Alle rollene er nå satt opp. \nBe spillerne logge seg inn, se på tilstanden i regionen deres de siste 45 årene og diskutere hvilke beslutninger de har tatt for å forbedre livet til befolkningen. Sjekk gjentatte ganger at alle spillerne har logget inn ved å klikke på knappen **Sjekk pålogginger**. Når de er klare til å gå videre til neste runde, **---** *dette kan ta en stund** **---** klikker du på knappen **Kjør modell for neste runde**. Hvis knappen *Kjør modell for neste runde* ikke vises, er ikke spillerne dine klare ennå. ",
  " _last_"
]
...
all_submitted_p_tx_str = [
    "ALL regions HAVE submitted their decisions, your game leader will advance the model shortly and let you know when your results are ready ",
