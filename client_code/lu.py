...
sign_up = [
  "Thanks for taking the time to explore the connections between poverty, inequality, empowerment, food and agriculture, and energy. The game is complicated, but not impossible to play. Because you get to decide the course of -future- history three times: When you take decisions for your own future, then for the future of your children and lastly, for the future of your grandchildren.",
  "Vielen Dank, dass Sie sich die Zeit genommen haben, die Zusammenhänge zwischen Armut, Ungleichheit, Empowerment, Ernährung und Landwirtschaft sowie Energie zu erkunden. Das Spiel ist kompliziert, aber nicht unmöglich zu spielen. Denn Sie können dreimal in die Zukunft eingreifen und somit den Verlauf der zukünftigen Geschichte mit-bestimmen: Wenn Sie Entscheidungen für Ihre eigene Zukunft treffen, dann für die Zukunft Ihrer Kinder und schließlich für die Zukunft Ihrer Enkelkinder.",
  "Vielen Dank, dass Sie sich die Zeit genommen haben, die Zusammenhänge zwischen Armut, Ungleichheit, Empowerment, Ernährung und Landwirtschaft sowie Energie zu erkunden. Das Spiel ist kompliziert, aber nicht unmöglich zu spielen. Denn Du kannst dreimal in die Zukunft eingreifen und somit den Verlauf der zukünftigen Geschichte mit-bestimmen: Wenn Du Entscheidungen für Deine eigene Zukunft triffst, dann für die Zukunft Deiner Kinder und schließlich für die Zukunft Deiner Enkelkinder.",
  "Merci d'avoir pris le temps d'explorer les liens entre pauvreté, inégalités, autonomisation, alimentation et agriculture, et énergie. Le jeu est compliqué, mais pas impossible à jouer. En effet, vous pouvez intervenir trois fois dans le futur et ainsi influencer le cours de l'histoire à venir: lorsque vous prenez des décisions pour votre propre avenir, puis pour celui de vos enfants et enfin pour celui de vos petits-enfants.",
  "Takk for at du tar deg tid til å utforske sammenhengen mellom fattigdom, ulikhet, myndiggjøring, mat og landbruk og energi. Spillet er komplisert, men ikke umulig å spille. Du kan nemlig gripe inn i fremtiden tre ganger og dermed være med på å bestemme hvordan historien vil utvikle seg: Når du tar beslutninger for din egen fremtid, deretter for dine barns fremtid og til slutt for dine barnebarns fremtid.",
  "_last_"  
]
sign_up_title = [
  "New registration",
...
gm_card_wait_1_info_tx_str = [
  ...
  "Alle Rollen sind nun eingerichtet. Bitten Sie Ihre Spieler:innen, sich **jetzt** mit der Spiel ID, die oben angezeigt wird, einzuloggen. \nSagen Sie Ihnen, sie sollen den Zustand ihrer Region in den letzten 45 Jahren betrachten und ihre Entscheidungen zur Verbesserung des Lebens ihrer Bevölkerung ausdiskutieren. \nÜberprüfen Sie wiederholt, ob sich alle Ihre Spieler:innen angemeldet haben, indem Sie auf die Schaltfläche **Anmeldungen prüfen** klicken. \nSobald sie bereit sind, mit der nächsten Runde fortzufahren, **---** das kann dauern! **---** klicken Sie auf die Schaltfläche **Modell für die nächste Runde laufen lassen**. Wenn die Schaltfläche *Modell für die nächste Runde laufen lassen* **nicht** angezeigt wird, sind Ihre Spieler:innen noch nicht soweit. ",
  "Alle Rollen sind nun eingerichtet. Bitten Sie Ihre Spieler:innen, sich **jetzt** mit der Spiel ID, die oben angezeigt wird, einzuloggen. \nSagen Sie Ihnen, sie sollen den Zustand ihrer Region in den letzten 45 Jahren betrachten und ihre Entscheidungen zur Verbesserung des Lebens ihrer Bevölkerung ausdiskutieren. \nÜberprüfen Sie wiederholt, ob sich alle Ihre Spieler:innen angemeldet haben, indem Sie auf die Schaltfläche **Anmeldungen prüfen** klicken. \nSobald sie bereit sind, mit der nächsten Runde fortzufahren, **---** das kann dauern! **---** klicken Sie auf die Schaltfläche **Modell für die nächste Runde laufen lassen**. Wenn die Schaltfläche *Modell für die nächste Runde laufen lassen* **nicht** angezeigt wird, sind Ihre Spieler:innen noch nicht soweit. ",
