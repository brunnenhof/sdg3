...
sign_up = [
  "Thanks for taking the time to explore the connections between poverty, inequality, empowerment, food and agriculture, and energy. The game is complicated, the future uncertain, but have no fear! We will guide you every step of the way, and you can intervene three times in the course of the future to tweek it for a better outcome: When you take decisions for your own future, then for the future of your children and lastly, for the future of your grandchildren.",
