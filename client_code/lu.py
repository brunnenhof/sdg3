...
lang_info_str = [
  "Welcome to the ... game. Thank you for taking the time to playfully explore the connections between poverty, inequality, empowerment, food & agriculture and energy. It's complex, but not incomprehensible. On the contrary, with your fellow players you can intervene three times in the course of events. To shape your future, the future of your children and the future of your grandchildren in a humane way. You will find out exactly how in the course of the game. \If English is sufficient, simply click on the *Let's go* button, otherwise select the desired language from the drop-down menu on the right-hand side. Over time we will add more and more languages, if you want to help with the translation, let us know. \ne-mail: lang at blue minus way dot net",
