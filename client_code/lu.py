...
historisch_fut = [
  "\nBelow are the historical results from 1980 onward, recreated by the model.",
  "\nWeiter unten finden Sie die historischen Ergebnisse ab 1980, die vom Modell nachgebildet wurden.",
  "\nWeiter unten findest Du die historischen Ergebnisse ab 1980, die vom Modell nachgebildet wurden.",
  "\nVous trouverez ci-dessous les résultats historiques depuis 1980, recréés par le modèle.",
  "\nNedenfor er de historiske resultatene fra 1980 og fremover, gjenskapt av modellen.",
  "_last_"  
]
p_info_60_fut = [
